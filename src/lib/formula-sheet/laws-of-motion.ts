  ...
  topicGroups: [
    ...
    // ── 4. Circular Dynamics ─────────────────────────────────────
    {
      ...
      formulas: [
        ...
        {
          id: "lom-conical-pendulum",
          expression: "T(period) = 2π √(L cosθ / g);   tanθ = v²/rg",
          expressionLatex: "T = 2\\pi\\sqrt{\\dfrac{L\\cos\\theta}{g}}",
          label: "Conical pendulum",
          derivedFrom: "Vertical balance T cosθ = mg with horizontal centripetal equation T sinθ = mv²/r",
          variables: [
            { symbol: "L", name: "string length", unit: "m", dimension: "[L]" },
            { symbol: "θ", name: "half-angle of the cone (string from vertical)", unit: "rad (or °)", dimension: "[M⁰L⁰T⁰]" },
            { symbol: "r", name: "radius of the horizontal circle (= L sinθ)", unit: "m", dimension: "[L]" },
          ],
          conditions: ["The bob can never swing fully horizontal — θ → 90° needs infinite speed", "Period depends on L cosθ (the vertical height), not on L alone"],
          commonMistakes: [
          ...
          examTags: ["jee-main", "neet", "mht-cet"],
          frequency: "high",
          examStats: { jeeMain: 5, neet: 7, mhtCet: 6 },
          difficulty: "medium",
          isKeyFormula: false,
          pdfInclude: true,
          searchKeywords: ["conical pendulum", "L cos theta", "horizontal circle string"],
        },
      ],
      importantObservations: [
